...
| ----- | ------------ | ------ | -------- |
| 1 | Toolchain recorded; `build/` is Cargo root | Done | [`evidence/p01/rust-toolchain.txt`](./evidence/p01/rust-toolchain.txt) |
| 2 | Crate `mkaf_md_parse`, `pulldown-cmark` 0.11.x, structured stdout | Done | [`build/`](../build/), [`evidence/p01/p01-cargo-build.txt`](./evidence/p01/p01-cargo-build.txt) |
| 3 | Happy path + missing-file run | Done | [`evidence/p01/complex-sample-run.txt`](./evidence/p01/complex-sample-run.txt), [`evidence/p01/p01-negative-missing-file.txt`](./evidence/p01/p01-negative-missing-file.txt) |
...
| ----- | ------ | ------ | -------- |
| 1 | Python 3.x recorded; `tts_inference.py`; **stub** backend (no pip deps) | Done | [`evidence/p02/p02-python-version.txt`](./evidence/p02/p02-python-version.txt), [`../build/tts_inference.py`](../build/tts_inference.py), [`../build/requirements-p02.txt`](../build/requirements-p02.txt) |
| 2 | P01 → chunk → strip for TTS | Done | [`evidence/p01/p01-stdout-for-p02.txt`](./evidence/p01/p01-stdout-for-p02.txt), [`evidence/p02/p02-pipeline-run.txt`](./evidence/p02/p02-pipeline-run.txt) |
| 3 | `.wav` files with unique names; empty-input edge | Done | [`evidence/p02/audio/`](./evidence/p02/audio/), [`evidence/p02/p02-audio-listing.txt`](./evidence/p02/p02-audio-listing.txt), [`evidence/p02/p02-edge-empty-stderr.txt`](./evidence/p02/p02-edge-empty-stderr.txt) |
...
| Phase | Target | Status | Evidence |
| ----- | ------ | ------ | -------- |
| 1 | Dioxus desktop shell; **Knowledge Viewer** window; crate layout supports CLI + UI | Done | [`evidence/p03/p03-viewer-build.txt`](./evidence/p03/p03-viewer-build.txt), [`../build/README.md`](../build/README.md) |
| 2 | Parsed markdown in UI state; section rendering | Done | `build/src/lib.rs`, `build/src/bin/knowledge_viewer.rs` |
| 3 | Per-section **Play Narration** (or equivalent) → P02 `.wav` paths | Done | `println!` path log; mapping note in [`evidence/p03/p03-viewer-build.txt`](./evidence/p03/p03-viewer-build.txt) |
| 4 | Evidence, [`../validation/P03-validation.md`](../validation/P03-validation.md) **PASS**, rollups | Done | [`evidence/p03/p03-cargo-test-lib.txt`](./evidence/p03/p03-cargo-test-lib.txt), [`evidence/p03/p03-cargo-release-cli.txt`](./evidence/p03/p03-cargo-release-cli.txt) |
...
- Parser lives in `build/src/lib.rs`; P01 stdout shape locked by unit test against [`evidence/p01/p01-stdout-for-p02.txt`](./evidence/p01/p01-stdout-for-p02.txt).
...
- Desktop **LNK1104** on very long `target/` paths is environmental — short **`CARGO_TARGET_DIR`**, `cargo clean`, or AV exclusion; see [`evidence/p03/p03-viewer-build.txt`](./evidence/p03/p03-viewer-build.txt) and [`evidence/p03/p03-viewer-release-build-success.txt`](./evidence/p03/p03-viewer-release-build-success.txt).
...
| Phase | Target | Status | Evidence |
| ----- | ------ | ------ | -------- |
| 1 | `serde` / `serde_json`; **`export`** binary; `flashcards.json` + `quiz.md` | Done | [`evidence/p04/p04-export-run.txt`](./evidence/p04/p04-export-run.txt), [`evidence/p04/p04-export-listing.txt`](./evidence/p04/p04-export-listing.txt), [`evidence/p04/exports/`](./evidence/p04/exports/) |
| 2 | `build/integration.py`; path map; AIRI contract | Done | [`evidence/p04/p04-integration-help.txt`](./evidence/p04/p04-integration-help.txt), [`evidence/p04/p04-integration-dry-run.txt`](./evidence/p04/p04-integration-dry-run.txt), [`evidence/p04/p04-integration-no-airi.txt`](./evidence/p04/p04-integration-no-airi.txt) |
| 3 | P01 → P02 → export ordering | Done | [`evidence/p04/p04-e2e-summary.txt`](./evidence/p04/p04-e2e-summary.txt), [`evidence/p04/p04-e2e-p02.txt`](./evidence/p04/p04-e2e-p02.txt), [`evidence/p04/p04-e2e-export.txt`](./evidence/p04/p04-e2e-export.txt) |
...
cargo run --release -- samples/complex-sample.md > ../executions/evidence/p04/p04-e2e-p01-stdout.txt
python tts_inference.py --from-file ../executions/evidence/p04/p04-e2e-p01-stdout.txt --output-dir ../executions/evidence/p02/audio
cargo run --release --bin export
```
