...
|---|--------|-------|-----------|--------|
| 1 | [retrieval-backbone-for-multi-domain-knowledge-systems](./retrieval-backbone-for-multi-domain-knowledge-systems/) | Citation-aware RAG: Unstructured + Qdrant → LlamaIndex + Ollama → web ingest (Firecrawl) → Ragas | Python, Qdrant, LlamaIndex, Ollama | ✅ **P01–P04** [PASS](./retrieval-backbone-for-multi-domain-knowledge-systems/validation.md) |
