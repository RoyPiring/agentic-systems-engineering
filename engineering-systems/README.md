...
| 11 | [retrieval-backbone-for-multi-domain-knowledge-systems](./retrieval-backbone-for-multi-domain-knowledge-systems/) | Citation-aware RAG: Unstructured + Qdrant → LlamaIndex + Ollama → Firecrawl → Ragas | Python, Qdrant, LlamaIndex, Ollama | 📋 Pre-P01 (scaffold + architecture) |
