...
| `evidence/` | Run artifacts only (logs, transcripts, toolchain capture). Use **`evidence/p01/`** … **`evidence/p04/`**; optional **`p02/audio/`**, **`p04/exports/`** when builds write binaries next to evidence. |
...
| P04 | `implementation/P04-implementation-plan.md` | `execution-record.md` | `../validation/P04-validation.md` | `evidence/p04/`, `p04/exports/` |
