...
4. Implementation detail: [P01 plan](../executions/implementation/P01-implementation-plan.md) · [P02 plan](../executions/implementation/P02-implementation-plan.md) · [P03 plan](../executions/implementation/P03-implementation-plan.md) · [P04 plan](../executions/implementation/P04-implementation-plan.md) · Toolchain layout: [`build/README.md`](../build/README.md).
...
| P04 | [P04-user-guide.md](./P04-user-guide.md) | **Ready** ([validation](../validation/P04-validation.md) **PASS**; evidence [`executions/evidence/p04/`](../executions/evidence/p04/)) |
| Series | [SERIES-user-guide.md](./SERIES-user-guide.md) | **P01**–**P04** linked |
